...
import { getKakaoUrl } from "../api/kakaoApi";
...
const LoginModal = ({ modalIsOpen, setModalIsOpen }) => {
    ...
    const { getKakaoUrl, isUrlLoading } = useKakaoLogin(() => setModalIsOpen(false));
    ...
    return (
      ...
      >
        <div className="p-6 text-copy-secondary flex flex-col justify-between">
          <h2 className="mb-6 text-xl font-bold text-copy-primary text-center">로그인</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <CustomButton type="submit" label="로그인" outline={false} size="lg" />
          </form>
