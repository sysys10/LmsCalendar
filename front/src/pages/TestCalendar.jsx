...
export default function MyCalendar() {
  ...
  return (
    <div className="min-h-screen pt-4 px-6 bg-background relative">
      <div className="flex-1">
        <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
          <h2 className="text-2xl font-bold text-copy-primary">일정 관리</h2>
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-card border border-border rounded-md shadow-sm text-sm font-medium text-copy-secondary"
            >
              오늘
            </button>
            <button
              onClick={() => onClickNavi("prev")}
              className="p-2 bg-card border border-gray-300 rounded-md shadow-sm text-sm font-medium text-copy-secondary hover:bg-gray-50"
            >
              ←
            </button>
            <button
              onClick={() => onClickNavi("next")}
              className="p-2 bg-card border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
              →
            </button>
